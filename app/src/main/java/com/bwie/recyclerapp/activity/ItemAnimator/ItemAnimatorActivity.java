package com.bwie.recyclerapp.activity.ItemAnimator;
...
public class ItemAnimatorActivity extends BaseActivity {
    ...
    @BindString(R.string.handle_header)
    protected String headerString;
    @BindString(R.string.handle_footer)
    protected String footerString;

    @NonNull
    @BindView(R.id.itemanimator_layout_header_btn)
    protected Button headerBtn;
    @NonNull
    @BindView(R.id.itemanimator_layout_footer_btn)
    protected Button footerBtn;
    ...
    @NonNull
    @OnClick(R.id.itemanimator_layout_header_btn)
    void onHeaderClick() {
        ItemAnimatorHeaderActivity.navigateToHeaderActivity(ItemAnimatorActivity.this);
    }

    @NonNull
    @OnClick(R.id.itemanimator_layout_footer_btn)
    void onFooterClick() {
