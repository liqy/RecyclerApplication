...
public class DecorationActivity extends BaseActivity {
    ...
    @NonNull
    @BindView(R.id.decoration_navigate_layout_standard_btn)
    protected Button standardBtn;
    @NonNull
    @BindView(R.id.decoration_navigate_layout_over_btn)
    protected Button overBtn;
    ...
    @NonNull
    @OnClick({R.id.decoration_navigate_layout_standard_btn, R.id.decoration_navigate_layout_over_btn})
