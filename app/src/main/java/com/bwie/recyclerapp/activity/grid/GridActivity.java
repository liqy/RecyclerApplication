...
public class GridActivity extends BaseActivity {
    ...
    @BindString(R.string.grid_recyclerView_standard)
    protected String standardString;
    @BindString(R.string.grid_recyclerView_auto_fix)
    protected String autoFixString;
    @BindString(R.string.grid_recyclerView_header)
    protected String headerString;

    @NonNull
    @BindView(R.id.grid_layout_standard_btn)
    protected Button standardBtn;
    @NonNull
    @BindView(R.id.grid_layout_auto_fix_btn)
    protected Button autoFixBtn;
    @NonNull
    @BindView(R.id.grid_layout_header_btn)
    ...
    @NonNull
    @OnClick(R.id.grid_layout_standard_btn)
    ...
    @NonNull
    @OnClick(R.id.grid_layout_auto_fix_btn)
    void onAutoFixClick() {
        GridAutoFixActivity.navigateToGridAutoFixActivity(GridActivity.this);
    }

    @NonNull
    @OnClick(R.id.grid_layout_header_btn)
    void onHeaderClick() {
        GridStandarOrHeaderdActivity.navigateToStandardOrHeaderActivity(GridActivity.this,
