...
public class LinearActivity extends BaseActivity {
    ...
    protected String verticalString;
    @BindString(R.string.linear_recyclerView_horizontal)
    protected String horizontalString;

    @NonNull
    @BindView(R.id.linear_layout_vertical_btn)
    protected Button verticalBtn;
    @NonNull
    @BindView(R.id.linear_layout_horizontal_btn)
    protected Button horizontalBtn;
